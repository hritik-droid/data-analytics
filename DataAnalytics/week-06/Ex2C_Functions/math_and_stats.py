...
circle_area_rounded_up = math.ceil(circle_area)
circle_area_rounded_down = math.floor(circle_area)
...
print(f"Radius = {radius}, area = {circle_area_rounded_up} rounded up to the nearest integer")
print(f"Radius = {radius}, area = {circle_area_rounded_down} rounded down to the nearest integer")
